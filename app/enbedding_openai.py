...
print(
    "Carpeta de persistencia (OpenAI):",
    os.path.abspath(PERSIST_DIR_OPENAI)
)


# Paso 2 — Crear cliente persistente de Chroma
client_chroma_openai = chromadb.PersistentClient(
    path=PERSIST_DIR_OPENAI
)
